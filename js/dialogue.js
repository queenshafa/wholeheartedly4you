document.addEventListener("DOMContentLoaded", () => {
  ...
  // You can change the dialogues here
  const dialogues = [
    { type: "text", text: "Oh hello!", next: 1 },
    {
      type: "text",
    ...
    { type: "text", text: "BUT WAIT!", next: 9 },
    { type: "text", text: "Before we get into it..", next: 10 },
    { type: "text", text: "I have to make sure..", next: 11 },
    {
      type: "captcha",
  ...
  function typeText(text, isChoice = false) {
    ...
    intervalId = setInterval(() => {
      ...
      if (i >= text.length) {
        ...
        typing = false;
        if (!isChoice) continueBtn.classList.remove("hidden");
      }
    }, 30);
  }
  ...
  dialogueBox.addEventListener("click", () => {
    ...
    if (typing) {
      ...
      typing = false;
      if (current.type === "text") continueBtn.classList.remove("hidden");
      return;
    }
